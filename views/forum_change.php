            ...
            <div class="user-box">
                <select name="id_matiere" id="matiere-select" required>
                    ...
                    foreach (hget("http://localhost:4567/api/getMatiere") as $m) {
                        ...
                        echo $question->id_matiere == $m->id_matiere ? "<option value=" . $m->id_matiere . " selected='selected'>" . $m->intitule . "</option>" :
                            "<option value=" . $m->id_matiere . ">" . $m->intitule . "</option>";}
                    ?>
                </select>
            </div>
            <div class="user-box">
                <textarea name="description" required placeholder="description :" ><?php echo $question->description ?></textarea>
            </div>
